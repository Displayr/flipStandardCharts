...
opts <- c('default' = '',
          ...
          'grid' = 'x.grid.width=4, y.grid.width=1, y.tick.distance = 2',
          'nogrid' = 'grid.show=FALSE, legend.show=FALSE',
          'ygrid' = 'y.grid.width = 0, data.label.show=TRUE, y.bounds.maximum = 5, x.tick.font.family="Arial Black"',
