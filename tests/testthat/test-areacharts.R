...
#
# ############################# ADDITIONAL EXAMPLES USING ALTERNATIVE DATA TYPES
...
# myLineCols <- c(rgb(31,78,121, max=255),rgb(192,0,0, max=255))
#
# AreaCharts(a.matrix, type = "Clustered Column",
#            transparency = 0.4,
#            colors = myCols,
#            y.tick.format = c("%","2"),
#            y.grid.show = TRUE,
