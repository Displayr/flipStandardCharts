...
test_that("HeatMap Extra Columns",
          ...
          expect_error(suppressWarnings(print(HeatMap(table = three.cols, left.columns = list(v1), left.column.headings = "HEADER, HEADER2"))), "Number of left column headings is different from number of left columns.")
