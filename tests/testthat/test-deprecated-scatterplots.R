context("(deprecated) Scatterplots")
...
test_that("Alternative arguments", {
    ...
    suppressWarnings(print(Chart(scatter.var.from.matrix=F, type="Scatterplot", colors="Primary colors", scatter.x.var=1:10, scatter.y.var=10:1, scatter.labels.var=LETTERS[1:10], scatter.colors.var=1:10, fit.type="Linear", fit.line.colors="Primary colors")))
})
