...
{
    print(Chart(y = good.examples[[i]]$Y, x = good.examples[[i]]$X, type = "Bar", transpose = good.examples[[i]]$transpose, title = names(good.examples)[i]), hover.include.source.value = TRUE)
