...
opts <- c('default' = '',
         ...
         'nolegend' = 'legend.show = FALSE',
         'markerbig' = 'series.marker.size = 10, grid.show = FALSE',
         'thickxgrid' = 'x.grid.width = 10, global.font.color = "red", global.font.family = "Courier"')

for (func in chart.funcs)
{
