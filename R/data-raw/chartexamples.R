...
qTab.examples <- list("ex1 - Area - Pick One by Pick One" = list(y = structure(c(0, 22, 18, 15, 16, 19, 13, 18, 27, 12, 0, 22, 21, 18, 20, 16, 14, 22, 24, 10),
                    ...
                    "ex20 - LScatter - Three columns, no span" = list(y = structure(c(11.3149847094801, 10.7033639143731, 7.64525993883792,
                                                              ...
                                                              "Q4. Drink categorical")), transpose = FALSE, type = "Labeled Bubbleplot", subtitle.text = NULL),
                    ...
                    "ex25 - LScatter - Crossed grid / Array " = list(y = structure(c(2.5, 65.625, 18.125, 8.75, 67.5, 10, 8.125, 100,
                                                                ...
                                                                "Q2. Gender")), transpose = FALSE, type = "Labeled Scatterplot", subtitle.text = NULL),
                    "ex26 - LScatter - Data Frame input" = list(y = structure(list(x = c(2.5, 1.875, 7.5, 65, 17.5, 22.5, 8.125,
...
devtools::use_data(qTab.examples, qTab.bad.examples, character.matrix, qColors, plotlySymbols, available.fonts, x.data, y.data, var1, var2, var3, var4, var5, alpha.five, logic.vector, logic.vector.named, named.vector.a, named.vector.b, factor.a, factor.b, x.dates, z, good.examples, bad.examples, errorAsChartMatrix.examples, errorIsChartMatrix.examples,
                   ex1.1, ex2.1, ex3.1, ex4.1, ex5.1, ex6.1, ex7.1, ex8.1, ex9.1, ex10.1, ex11.1, ex12.1, ex13.1, ex14.1, ex15.1, ex16.1, ex17.1, ex18.1, ex19.1, ex20.1, ex21.1, ex22.1, ex23.1, ex24.1, ex25.1, ex26.1, ex27.1, ex28.1, ex29.1,
                   ex1.2, ex2.2, ex3.2, ex4.2, ex5.2, ex6.2, ex7.2, ex8.2, ex9.2, ex10.2, ex11.2, ex12.2, ex13.2, ex14.2, ex15.2, ex16.2, ex17.2, ex18.2, ex19.2, ex20.2, ex21.2, ex22.2, ex23.2, ex24.2, ex25.2, ex26.2, ex27.2, ex28.2, ex29.2,
