...
qTab.examples <- list("Pick One by Pick One" = list(y = structure(c(0, 22, 18, 15, 16, 19, 13, 18, 27, 12, 0, 22, 21, 18, 20, 16, 14, 22, 24, 10),
                      ...
                      "Y Number Multi" = list(y = structure(c(2.98165137614679, 4.11009174311927, 3.07339449541284,
                      ...
                      "Y Number by Pick One" = list(y = structure(c(2.92537313432836, 3.01666666666667, 3.02380952380952,
                      ...
                      "Y Pick One by X Pick One for stacked example" = list(y = structure(c(0, 26, 17, 13, 20, 12, 6, 19, 14, 7, 0, 8, 10, 6,
                      ...
                      "Y Pick One by X Pick One for 100pct stacked example" = list(y = structure(c(0, 26, 17, 13, 20, 12, 6, 19, 14, 7, 0, 8, 10, 6,
                                                               6, 4, 8, 8, 8, 2, 0, 2, 3, 4, 8, 6, 3, 6, 8, 2, 0, 4, 0, 4, 1,
                                                               3, 3, 1, 7, 2, 0, 0, 1, 1, 0, 3, 2, 2, 4, 5, 0, 4, 8, 5, 1, 7,
                                                               5, 4, 10, 4), .Dim = c(10L, 6L), statistic = "n", .Dimnames = list(
                                                               c("Less than 18", "18 to 24", "25 to 29", "30 to 34", "35 to 39",
...
devtools::use_data(qTab.examples, qTab.bad.examples, qColors, plotlySymbols, available.fonts, x.data, y.data, var1, var2, var3, var4, var5, alpha.five, logic.vector, logic.vector.named, named.vector.a, named.vector.b, factor.a, factor.b, x.dates, z, good.examples, good.examples.area.chart, bad.examples, errorAsChartMatrix.examples, errorIsChartMatrix.examples,
