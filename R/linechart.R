...
#' @param type Character; type of chart. Can be "Line", "Stacked Line",
#' or "100\% Stacked Line".
...
#' @param transparency Transparency of line fill colors as an alpha value
#' (0 to 1).
...
#' @param plot.fill.color Plot (the plot line proper) background color as
#' a named color in character format (e.g. "black") or an rgb value (e.g.
#' rgb(0, 0, 0, max = 255)).
#' @param plot.fill.transparency Plot (the plot line proper) background
#' transparency as an alpha value (0 to 1).
...
#' @param margin.top Integer; margin between plot line and the top of the
#' graphic in pixels
#' @param margin.bottom Integer; margin between plot line and the top of the
#' graphic in pixels
#' @param margin.left Integer; margin between plot line and the top of the
#' graphic in pixels
#' @param margin.right Integer; margin between plot line and the top of the
#' graphic in pixels
...
#' data("y.data")
#' data("x.data")
#' LineChart(y = y.data, x = x.data, transpose = FALSE)
#' @export
...
#                         type = "Line",                                    ## Type of char; can be "Line", "Stacked Line", or "100% Stacked Line"
#                         title = "",                                       ## Chart title
...
#                         transparency = 0.4,                               ## Transparency of line fill colors
...
#                         plot.fill.color = rgb(255, 255, 255, maxColorValue = 255),  ## Plot (the plot line proper) background color
#                         plot.fill.transparency = 1,                       ## Plot (the plot line proper) background color transparency
...
#                         margin.top = 80,                                  ## Margin between plot line and the top of the graphic
#                         margin.bottom = 80,                               ## Margin between plot line and the bottom of the graphic
#                         margin.left = 80,                                 ## Margin between plot line and the left of the graphic
#                         margin.right = 80,                                ## Margin between plot line and the right of the graphic
...
#
#     ## Issue warning if transparency is = 1 and type = "Line"
#     if (transparency == 1 && type == "Line")
...
#
#     # Create text matrix of source data if required for series data points.
#     if (series.marker.text)
#     {
#         source.matrix <- chart.matrix
#         if (series.marker.text.percent)
#             source.matrix <- source.matrix * 100
#
#         ## should return a character matrix with blank spaces depending on settings.
...
#
#     ## Determine whether to draw to zero y (overlapping line chart) or to next y (for stacked)
#     if (type == "Line")
#         fill.bound <- "tozeroy"
#     else
#         fill.bound <- "tonexty"
...
#     }
#
#     ## Group legend items if it's a stacked line chart as taking individual items off makes no sense
#     legend.group <- ""
#     if (type != "Line")
